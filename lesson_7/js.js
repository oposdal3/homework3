...
const score = {
    ...
    getScoreCount() {
        return this.text + String(this.scoreCount);
    },
    ...
    init() {
        ...
        h1.textContent = this.getScoreCount();
    ...
    getNextStepHeadPoint() {
        ...
        if (this.direction == 'up') {
            if (firstPoint.y != 0) {
                ...
                return { x: firstPoint.x, y: config.getColsCount() - 1 };
            }
        } else {
            if (this.direction == 'right') {
                if (firstPoint.x != config.getRowsCount() - 1) {
                ...
                if (this.direction == 'down') {
                    if (firstPoint.y != config.getColsCount() - 1) {
                        return { x: firstPoint.x, y: firstPoint.y + 1 };
                    } else {
                    ...
                    if (this.direction == 'left') {
                        if (firstPoint.x != 0) {
                            ...
                            return { x: config.getRowsCount() - 1, y: firstPoint.y };
                        }
                    }
                }
            }
...
const game = {
    ...
    getRandomFreeCoordinates() {
        const exclude = [this.rock.getCoordinates(), this.food.getCoordinates(), ...this.snake.getBody()];
